...
JOBMA_BASE_URL = get_string("JOBMA_BASE_URL", "")
JOBMA_ACCESS_TOKEN = get_string("JOBMA_ACCESS_TOKEN", "")
JOBMA_WEBHOOK_ACCESS_TOKEN = get_string("JOBMA_WEBHOOK_ACCESS_TOKEN", "")

SITE_BASE_URL = get_string("JOBMA_BASE_URL", None)
