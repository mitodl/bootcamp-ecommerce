...
describe("SubmissionFacets", () => {
  ...
  it("should render all provided options", async () => {
    ...
    const bootcampFacetOptions = wrapper.find(".facet").at(0).find("Option");
    // $FlowFixMe
    ...
    const reviewFacetOptions = wrapper.find(".facet").at(1).find("Option");
  ...
  it("should let you activate a facet by clicking", async () => {
    ...
    [0, 1].forEach((index) => {
      wrapper.find(".facet").at(index).find("Option").at(0).simulate("click");
    });
