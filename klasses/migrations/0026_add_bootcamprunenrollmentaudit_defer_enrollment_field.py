...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='change_status',
            field=models.CharField(blank=True, choices=[('deferred', 'deferred'), ('refunded', 'refunded')], max_length=20, null=True),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='klasses.BootcampRunEnrollment')),
            ],
            options={
                'abstract': False,
            },
