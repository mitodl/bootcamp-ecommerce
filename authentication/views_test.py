...
def mock_email_send(mocker):
    ...
    yield mocker.patch("mail.v2.verification_api.send_verification_email")
...
class AuthStateMachine(RuleBasedStateMachine):
    ...
    email_send_patcher = patch(
        "mail.v2.verification_api.send_verification_email", autospec=True
    )
    ...
    def __init__(self):
        ...
        self.stack.enter_context(
            override_settings(**{"FEATURES": {features.SOCIAL_AUTH_API: True}})
        )
