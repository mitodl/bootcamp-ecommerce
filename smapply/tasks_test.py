...
test_user_data = [
    {'id': 12345678, 'full_name': 'first_name last_name', 'first_name': 'first_name', 'last_name': 'last_name',
    ...
    {'id': 87654321, 'full_name': 'testy testname', 'first_name': 'testy', 'last_name': 'testname',
...
def test_sync_all_users_bad_data(mocker):
    ...
    """
    test_user_data[0].pop('full_name')
    mocker.patch(
        'smapply.tasks.list_users',
        return_value=test_user_data,
    )
